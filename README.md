...
<img src='https://github.com/maygupta/image_search/blob/master/imagesearch4.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

* Working with Staggered views
* Styling dialog fragments
* Passing content to and fro from fragments using event handlers
